    ...
    return (
      <ScrollView style={{flex:1,backgroundColor:"white"}}>
        ...
        >
          ...
          />
          <WisInput  
            {...getFieldProps('zynum1',{
              rules:[{required:true }],
              initialValue:zynum1
            })} 
            error={getFieldError('zynum1')}               
            lableName="加油量"
            extra={"需加油量"+zynum}
          />
          <WisInput  
            {...getFieldProps('znnum1',{
              rules:[{required:true }],
              initialValue:znnum1
            })} 
            error={getFieldError('znnum1')}               
            lableName="加尿素量"
            extra={"需加尿素量"+znnum}
          />
        ...
        <Button type="ghost" onPress={() =>this.submit("2")}>加油确认</Button>
        <Button type="ghost" onPress={() =>this.submit("3")}>尿素确认</Button>
        <Button type="ghost" onPress={() =>this.submit("4")}>确认</Button>
        </View>
      </ScrollView>
    );
  }
